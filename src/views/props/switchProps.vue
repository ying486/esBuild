  ...
  <div class="switch-props">
    <Form :model="props" label-position="left" :label-width="80">
      ...
      <div class="block">
        ...
        <FormItem label="true-color">
          <!-- <ColorPicker v-model="props['true-color']" alpha /> -->
          <Input
            v-model="props['true-color']"
            placeholder="#2D8CF0"
            size="small"
            clearable
          />
        </FormItem>
        <FormItem label="false-color">
          <!-- <ColorPicker v-model="props['false-color']" alpha /> -->
          <Input
            v-model="props['false-color']"
            placeholder="#CCCCCC"
            size="small"
            clearable
          />
        ...
        <Row>
          <Col span="12">
            <FormItem label="loading">
              <Checkbox v-model="props.loading" />
            </FormItem>
          </Col>
          <Col span="12">
